      ...
      <div className="flex">
        ...
        {closable && onClose && (
          <div className="ml-auto pl-3">
            <button
              onClick={onClose}
              className="inline-flex rounded-md p-1.5 hover:bg-black/10 focus:ring-2 focus:ring-current focus:ring-offset-2 focus:ring-offset-transparent focus:outline-none"
            >
